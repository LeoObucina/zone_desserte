...
/***************************************************************************
 ...
 Generated by Plugin Builder: http://g-sherman.github.io/Qgis-Plugin-Builder/
        ...
        begin                : 2025-01-09
        git sha              : $Format:%H$
        copyright            : (C) 2025 by Léo Obucina
        email                : leo.obucina@suez.com
 ***************************************************************************/
...
class zonedesserte:
    ...
    def __init__(self, iface):
        ...
        locale_path = os.path.join(
            self.plugin_dir,
            'i18n',
            'zonedesserte_{}.qm'.format(locale))
        ...
        self.actions = []
        self.menu = self.tr(u'&Zone de desserte')
    ...
    def initGui(self):
        ...
        self.add_action(
            icon_path,
            text=self.tr(u'Zone de desserte'),
            callback=self.run,
